	...
	return (
		<>
			<div
				...
				rounded-xl py-4 px-5 transitions-all
			...
			>
				<div className={`grid items-center 
					...
					<p
						className='text-slate-200 filter drop-shadow text-base
				...
				<div className='flex items-center gap-3'>
					<button 
                        ...
                        p-0.5 shadow shadow-sky-200 text-sm text-black'
                    >
                ...
                <div className={`flex items-center 
				    ...
				    <img 
                        src={img} 
                        alt={`img/item-img/${id}`}
                        className={`w-64 transitions-theme hover:-rotate-12 object-fill
						${ifExists ? 'h-auto lg:w-56 md:w-48 -rotate-[35deg]' : 'h-36'}`}
                    />
			    </div>
			</div>
		</>
