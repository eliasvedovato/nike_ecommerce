    ...
    <>
      <div className={`flex items-center justify-between lg:flex-col 
        ...
        <div className='max-w-lg lg:max-w-none w-full md:text-center 
            grid items-center lg:justify-items-center'>
            ...
            <a href={url} className='flex items-center' target={'_blank'} role='button' >
                <button 
                    type='button' 
                    className='button-theme bg-slate-900 
                    shadow-slate-900 text-slate-100'>
                    {btn}
                </button>
            </a>
        </div>
        <div className='flex items-center justify-center max-w-xl relative
            ...
            <img src={img} alt={`img/${heading}`}
                className={`w-auto object-fill mt-8 transitions-theme ${ifExists ?
