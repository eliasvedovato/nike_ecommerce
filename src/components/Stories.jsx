			...
			<div className='nike-container mb-11'>
				...
				<div className='mt-7'>
					<Splide options={splideOptions}>
						{news.map((val, i) => (
							<SplideSlide key={i} className='mb-0.5'>
								<div
									className='relative grid icoms-center gap-4 pb-2 rounded-lg shadow
                  shadow-slate-200 ring-1 ring-slate-200'
								>
									<div className='flex items-center justify-center'>
										<img
											src={val.img}
											alt={`img/story/${i}`}
											className='w-full h-auto object-cover shadow-m shadow-slate-200
                      rounded-tl-lg rounded-tr-lg'
									...
									<div className='flex items-center justify-between w-full px-4'>
										...
										<div className='flex items-center gap-0.5'>
											...
											<span className='text-xs font-boold text-blue-600'>
												{val.by}
											</span>
										</div>
									</div>
                      ...
                      shadow-md shadow-black text-center text-slate-100 py-1.5
                      button-theme'
										>
											{val.btn}
										</a>
