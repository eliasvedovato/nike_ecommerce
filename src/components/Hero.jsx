...
const Hero = ({
	...
	// console.log(heroapi.title)
	return (
		<div className='relative h-auto w-auto flex flex-col'>
			<div className='bg-theme clip-path h-[85vh] lg:h-[75vh] 
      md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 
      right-0 opacity-100 z-10'></div>
			<div className='relative opacity-100 z-20 grid items-center
      justify-items-center nike-container'>
        ...
        md:mt-24 '>
          ...
          top-[33vh] lg:top-[27vh] left-[5%] xl:left-0 w-auto h-auto'>
            {videos?.map((val, i) => (
              <Clips 
                key={i} 
                imgsrc={val.imgsrc}
              ...
              />
					...
					<div className='grid items-center absolute top-[33vh]
          lg:top-[27vh] right-0 gap-3'>
            ...
            src={img} 
            alt='hero-img/img'
            className='w-auto pr-16 h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh]
            transitions-theme rotate-[-25deg] hover:rotate-[-45deg] cursor-pointer object-fill'
          />
				</div>
			</div>
		</div>
